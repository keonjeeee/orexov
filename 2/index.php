        ...
        <div class="modal_body">
          <div class="modal-dialog" role="document" >
            <div class="modal-content rounded-4 shadow">
              <div class="modal-header border-bottom-0" style="margin-bottom:40px;text-align:center">
                <div>
                  <h1 class="modal-title fs-5">Окно</h1>
                </div>
                <div>
              ...
              <span id="span1" style="background:#615a5a;padding:5px;border-radius:20px"></span>
              </div>
              <div style="margin:20px;">
              <span id="span2" style="background:#615a5a;padding:5px;border-radius:20px"></span>
              </div>
              <div style="margin:20px;">
              <span id="span3" style="background:#615a5a;padding:5px;border-radius:20px"></span>
              </div>
              <div style="margin:20px;">
              <span id="span4" style="background:#615a5a;padding:5px;border-radius:20px"></span>
              </div>
              </div>
            </div>
          </div>
